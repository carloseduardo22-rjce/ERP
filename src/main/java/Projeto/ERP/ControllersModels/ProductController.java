...
public class ProductController {
    ...
    public ResponseEntity<CustomResponse<Product>> deleteProduct(@PathVariable UUID id) {
        productService.deleteProduct(id);
        Date date = new Date();
        CustomResponse<Product> response = new CustomResponse<>(true, 201, "Product Removed", date);
